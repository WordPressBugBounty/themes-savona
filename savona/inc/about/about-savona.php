...
function savona_about_page() {
	add_theme_page( esc_html__( 'About Savona', 'savona' ), esc_html__( 'Savona Theme', 'savona' ), 'edit_theme_options', 'about-savona', 'savona_about_page_output', 1 );
}
	...
	<div class="wrap">
		...
		<div class="nav-tab-wrapper">
			...
			<a href="?page=about-savona&tab=savona_tab_4" class="nav-tab <?php echo $active_tab == 'savona_tab_4' ? 'nav-tab-active' : ''; ?>">
				<?php esc_html_e( 'Savona Free vs Pro', 'savona' ); ?>
			</a>
		</div>
